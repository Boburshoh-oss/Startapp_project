...
urlpatterns = [
    ...
    path('successprojects' , successProject , name='successproject'),
    path('project_details/<int:pk>' , projectDetatils , name='project_detail'),
    path('commets/<int:pk>', comments , name='comment')
